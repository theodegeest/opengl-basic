...
#define SIM_WIDTH 125
#define SIM_HEIGHT 75
...
static void update_sim_sand(PixelSimObj *obj, int x, int y, Quad *q1) {
...
static void update_sim(PixelSimObj *obj, int x, int y) {
